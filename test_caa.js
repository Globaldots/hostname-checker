...
// Note: In curl JSON output "data" had double backslash "\\#". In JS string "\\#" becomes "\#".
const testData = [
    ...
    { "name": "bbc.com", "type": 257, "TTL": 300, "data": "0 issue \"google.com\"" } // Control
];

testData.forEach(r => {
    console.log('Input:', r.data);
    const parsed = parseCAA(r);
